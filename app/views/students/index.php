        ...
        <li class="list-group-item d-flex justify-content-between align-items-center list-group-item-action">
            ...
            <div class="btn-group dropend">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?=BASEURL;?>/students/delete/<?=$student['id'];?>" class="dropdown-item" style="text-decoration:none" 
                        onclick="return confirm('Are you sure to delete this data?');">Delete</a></li>
                </ul>
            <div>
        </li>
    <?php endforeach;?>
